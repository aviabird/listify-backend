...
module Oauth
  class Twitter
    ...
    def initialize params
      @client = TwitterOAuth::Client.new( consumer_key: 'TSOSvmRILlXHXeci9WJPFwmEX', consumer_secret: '5hoSZ6AkGnJ3u6UCicBnTK66lWkK36NYDa1Bm4LwAw4r1P0JBL')
      @params = params
    ...
    def request_token
      if @request_token.blank?
        @token = @client.request_token(oauth_callback: "http://127.0.0.1:3000/api/auth/twitter")
    ...
    def get_account
      @twitter_account = TwitterOAuth::Client.new(
        consumer_key: 'Or0zIiCWlH3NPoAoYlkDecLUf', 
        consumer_secret: 'NJfWYkjmDQBhFO7FjWmKvwqwtewD0ITTERSgbSYXj0410wMmel00x5P',
